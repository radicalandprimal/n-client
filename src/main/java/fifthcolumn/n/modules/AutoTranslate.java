...
public class AutoTranslate extends Module {
    ...
    public AutoTranslate() {
        ...
        this.translateOut = this.sgGeneral.add(new BoolSetting.Builder().name("Translate outgoing").description("messages you send").defaultValue(false).build());
        this.translateIn = this.sgGeneral.add(new BoolSetting.Builder().name("Translate incoming").description("messages you receive").defaultValue(true).build());
        this.serverLang = this.sgGeneral.add(new EnumSetting.Builder<Lang>().name("Server Language").description("Language the server speaks").defaultValue(Lang.RUSSIAN).build());
        this.localLang = this.sgGeneral.add(new EnumSetting.Builder<Lang>().name("Local Language").description("Language you speak").defaultValue(Lang.ENGLISH).build());
    }

    @EventHandler
    private void onMessageSend(SendMessageEvent event) {
        if (this.translateOut.get().booleanValue()) {
    ...
    private void onMessageReceive(ReceiveMsgEvent event) {
        if (this.translateIn.get().booleanValue()) {
