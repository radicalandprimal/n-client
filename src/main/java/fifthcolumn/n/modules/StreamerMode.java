...
public class StreamerMode extends Module {
    ...
    public StreamerMode() {
        ...
        this.generifyPlayerNames = this.sgGeneral.add(new BoolSetting.Builder().name("use a generic name for non-griefers").defaultValue(true).build());
        this.addFakePlayers = this.sgGeneral.add(new IntSetting.Builder().name("add fake players to tablist").sliderRange(0, 10).defaultValue(5).build());
