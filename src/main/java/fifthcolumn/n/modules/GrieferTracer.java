...
public class GrieferTracer extends Module {
    ...
    public GrieferTracer() {
        ...
        this.playersColor = this.sgGeneral.add(new ColorSetting.Builder().name("players-colors").description("The griefers color.").defaultValue(new SettingColor(205, 205, 205, 127)).build());
    }
