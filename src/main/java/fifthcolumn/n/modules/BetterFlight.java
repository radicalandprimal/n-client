...
public class BetterFlight extends Module {
    ...
    public BetterFlight() {
        ...
        this.speed = this.sgGeneral.add(new DoubleSetting.Builder().name("base speed").description("Your speed when you start to fly.").defaultValue(1.0).min(0.0).build());
        this.maxSpeed = this.sgGeneral.add(new DoubleSetting.Builder().name("maximum speed").description("The maximum speed used for velocity speed").defaultValue(5.0).min(0.0).max(10.0).build());
        this.velocitySpeed = this.sgGeneral.add(new BoolSetting.Builder().name("velocity speed").description("increases the velocity the longer you fly").defaultValue(true).build());
        this.antiKickModeSetting = this.sgGeneral.add(new EnumSetting.Builder<AntiKickMode>().name("anti-kick mode").description("method for anti-kick").defaultValue(AntiKickMode.PACKET).build());
