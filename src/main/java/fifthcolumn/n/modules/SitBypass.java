...
public class SitBypass extends Module {
    ...
    public static final EntityType<EntityImpl> SIT_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, new Identifier("sit", "entity_sit"), FabricEntityTypeBuilder.create(SpawnGroup.MISC, EntityImpl::new).dimensions(EntityDimensions.fixed(0.001f, 0.001f)).build());
