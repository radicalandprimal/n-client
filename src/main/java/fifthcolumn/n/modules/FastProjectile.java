...
public class FastProjectile extends Module {
    ...
    public FastProjectile() {
        ...
        this.packetFactor = this.sgGeneral.add(new IntSetting.Builder().name("packet-factor").description("How many packets to send, more packets means more power.").defaultValue(100).min(1).max(200).sliderRange(1, 200).build());
    }
