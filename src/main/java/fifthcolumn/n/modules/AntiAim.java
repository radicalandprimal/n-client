...
public class AntiAim extends Module {
    ...
    public AntiAim() {
        ...
        this.mode = this.sgGeneral.add(new EnumSetting.Builder<Mode>().name("mode").defaultValue(Mode.Spin).build());
        this.speed = this.sgGeneral.add(new IntSetting.Builder().name("speed").visible(() -> this.mode.get() == Mode.Spin).defaultValue(5).min(1).max(10).build());
    }
