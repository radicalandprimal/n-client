...
// https://github.com/ZimnyCat/BigRat/blob/3dc274a18e5912f904f30734fdcf858b0aaf964f/src/main/java/bleach/hack/utils/FabricReflect.java
public class FabricReflect {
    ...
    public static void writeField(final Object target, Object value, String obfName, String deobfName) {
        if (target == null) return;

        final Class<?> cls = target.getClass();
        final Field field = FabricReflect.getField(cls, obfName, deobfName);
