...
public class CopeMultiplayerScreen extends Screen {
    ...
    protected void init() {
        ...
        this.buttonJoin = this.addDrawableChild(ButtonWidget.builder(Text.translatable("selectServer.select"), button -> this.connect()).dimensions(farLeftXTopRow, buttonTopRowY, 80, 20).build());
        ...
        }).dimensions(farLeftXTopRow + 4 + 80, buttonTopRowY, 80, 20).build());

        this.addDrawableChild(ButtonWidget.builder(Text.of("Hide Server"), button -> this.serverListWidget.removeSelectedServerEntry()).dimensions(farLeftXTopRow + 168, buttonTopRowY, 80, 20).build());
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.of("Proxies"), button -> this.client.setScreen(GuiThemes.get().proxiesScreen())).dimensions(this.width - 75 - 3, 3, 75, 20).build());

        this.addDrawableChild(ButtonWidget.builder(Text.of("Accounts"), button -> this.client.setScreen(GuiThemes.get().accountsScreen())).dimensions(this.width - 75 - 3 - 75 - 2, 3, 75, 20).build());
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.of("Reset account"), button -> copeService.setDefaultSession()).dimensions(this.width - 75 - 3 - 230 - 2, 3, 80, 20).build());
    }
